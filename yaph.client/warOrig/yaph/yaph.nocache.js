...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "yaph" because\n';
 ...
 * "/yaph.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['yaph'].superdevmode = true;

  var expectedSuffix = '/yaph.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + yaph + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:yaph';
  var devModeSessionKey = '__gwtDevModeSession:yaph';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/yaph/yaph.nocache.js';
  ...
  $wnd.__gwt_activeModules['yaph'].canRedirect = true;
  $wnd.__gwt_activeModules['yaph'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/yaph?user.agent=' + ua + '&_callback=' + callback;
