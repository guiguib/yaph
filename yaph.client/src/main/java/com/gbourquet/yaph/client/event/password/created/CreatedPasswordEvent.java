...
public abstract class CreatedPasswordEvent extends GwtEvent<CreatedPasswordEventHandler> {
	...
	@Override
	protected abstract void dispatch(final CreatedPasswordEventHandler handler);
